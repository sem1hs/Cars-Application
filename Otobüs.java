...
public class Otobüs extends Arac{
	...
	private String MuavinSayi;
	
	private String[] Teker = {"Sağ","Sol","Ön","Arka"}; 
	private int[] TekerDurum = {0,0,0,0};
	private int Sigorta=0;
	
	public Otobüs(String AracMarka,String AracModel,String AracUretimYil,String AracMotor,String AracKilometre,String KoltukSayi,String MuavinSayi)
	{
		super(AracMarka,AracModel,AracUretimYil,AracMotor,AracKilometre);
		this.KoltukSayi = KoltukSayi;
		this.MuavinSayi = MuavinSayi;
	}
	public void AracBilgiGoster()
	{
		super.AracBilgiGoster();
		System.out.println("Koltuk Sayısı : " + this.KoltukSayi + " Muavin Sayısı : " + this.MuavinSayi);
	}
